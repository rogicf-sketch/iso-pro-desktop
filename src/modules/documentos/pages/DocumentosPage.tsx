...
export function DocumentosPage() {
  ...
  useEffect(() => {
    if (viewDocId == null) return;
    void carregarMetricasPlanejamentoPorCodigo().then(setMetricasVisualizacao);
  }, [viewDocId]);

  if (!viewDocument && metricasVisualizacao.size > 0) {
  ...
  return (
    <div className="panel">
      ...
      <p className="panel-copy">
        ...
        saldo; arquivo CSV com separador <code>;</code> para abrir no Excel em portugues.
      ...
      <Modal onClose={closeModal} open={isModalOpen && canEdit} title={selected ? 'Editar documento' : 'Novo documento'}>
        <DocumentoForm
      ...
      <Modal onClose={closeImportDocumentosResultado} open={Boolean(importResultado)} title="Importacao concluida">
        {importResultado ? (
          <div className="editor-block">
            <p>
      ...
      >
        {viewDocument ? (
          <div className="editor-block">
            ...
            <div className="form-actions">
              <Button onClick={closeViewDocument} type="button">
                Fechar
              </Button>
            </div>
          </div>
